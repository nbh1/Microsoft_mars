...
var AI = function(level) {
    ...
    /*
     * private function: make the ai player take a hard move,
    ...
    this.notify = function(turn) {
        switch(levelOfIntelligence) {
            ...
            case "medium": takeAMediumMove(turn); break;
            case "hard": takeAHardMove(turn); break;
        }
    };
};
/*
...
$(".reset").click(function(){
    ...
    if(targetCell.hasClass('occupied')) {
        ...
        globals.game.currentState.board[i]="E";

    }
    globals.game.status = "beginning";
    ui.intialControlsVisible = true;
     $('.intial').fadeIn({
            duration : "slow",
